<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="预售定金" prop="discount"/>

      <el-table-column align="center" label="预售尾款" prop="discountMember"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form
        ...
        <el-form-item label="预售定金" prop="discount">
          <el-input v-model="dataForm.discount"/>
        </el-form-item>
        <el-form-item label="预售尾款" prop="discountMember">
          <el-input v-model="dataForm.discountMember"/>
        </el-form-item>
        <el-form-item label="预售开始时间" prop="startTime">
          <el-date-picker
        ...
        <el-form-item label="预售结束时间" prop="expireTime">
          <el-date-picker
